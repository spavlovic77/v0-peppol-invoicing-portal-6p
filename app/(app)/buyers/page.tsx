...
export default function BuyersPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">Odberatelia</h1>
          <p className="text-muted-foreground mt-1">
            Ulozene kontakty pre {activeSupplier.company_name}
          </p>
        </div>
        {!showForm && (
          <button
        ...
        <GlassCard>
          <div className="flex items-center justify-between mb-6">
            <h2 className="font-semibold text-foreground">
              {editingId ? 'Upravit odberatela' : 'Novy odberatel'}
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-4">
            <BField label="Nazov firmy *" value={form.company_name} onChange={(v) => setForm({ ...form, company_name: v })} />
          ...
          <div className="flex justify-end">
            ...
            >
              ...
              {editingId ? 'Ulozit zmeny' : 'Pridat kontakt'}
            </button>
          </div>
        </GlassCard>
      )}
      ...
      {buyers.length === 0 && !showForm ? (
        <GlassCard className="text-center py-16">
          ...
          <h2 className="text-lg font-semibold text-foreground mb-2">Ziadne ulozene kontakty</h2>
