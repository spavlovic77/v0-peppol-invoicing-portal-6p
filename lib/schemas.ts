...
export const peppolInvoiceSchema = z.object({
  ...
  supplierEndpointSchemeId: z.string().describe('Always "9950" for Slovak Peppol network'),
  ...
  customerEndpointSchemeId: z.string().describe('Customer endpoint scheme, e.g. 9950'),
