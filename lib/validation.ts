...
export function validatePeppolSchematron(inv: PeppolInvoice): ValidationPhase {
  ...
  // Endpoint scheme validation (0245 for Slovakia)
  if (inv.supplierCountryCode === 'SK') {
    check('PEPPOL-SK-R001', inv.supplierEndpointSchemeId === '0245', 'Pre slovensky subjekt musi byt schema endpointu 0245', 'warning')
  }
